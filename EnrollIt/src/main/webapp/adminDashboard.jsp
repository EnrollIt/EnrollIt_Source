...
<body>
<div width ="100%">
<input type="button" value="Add School" data-target=".loginModal" data-toggle="modal" >
</div>
<form >
	<table width="100%">
		<tr>
		...
		<tr align ="center">
			...
			<td>
				<input type="submit"  formaction="/edit/a" value="edit" />
				<input type="submit"  formaction="/delete/a"value="delete" />
                ...
                "img-responsive" src="images/logoPopUp.png">
                     ...
                     <div class="row">
                        ...
                        "form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                placeholder="Pin Code" type="number" max=999999 min =100000>
                            </div>
                        </div>
                    </div>
                     <div class="row">
                     ...
                     <div class="row">
                        ...
                        "form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class=
                            "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input class="form-control" id="fees"
                    ...
                    <div class="clearfix" display="inline" >
                        ...
                        "form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class=
                            "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            	<label for="facility">faclity 1</label>
                                <input  id="facility" 
                                placeholder="Fees" type="checkbox" name="facilties" value="facilty 1">
                            	<label for="facility">faclity 2</label>
                            	<input  id="fees"
                                placeholder="Fees" type="checkbox" name="facilties" value="facilty 2">
                                <label for="facility">faclity 3</label>
                                <input  id="fees"
                                placeholder="Fees" type="checkbox" name="facilties" value="facilty 3">
                                <label for="facility">faclity 4</label>
                                <input  id="fees"
                                placeholder="Fees" type="checkbox" name="facilties" value="facilty 4">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        "col-lg-12 col-md-12 col-sm-12 col-xs-12 SignUpPanel">
                            <button class=
                            " form-control btn btnSignUp col-lg-6 col-md-6 col-sm-6 col-xs-12"
