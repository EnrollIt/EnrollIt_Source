						...
						<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<label for="facility">faclity 1</label> <input id="facility"
									placeholder="Fees" type="checkbox" name="facilties"
									value="facilty 1"> <label for="facility">faclity
									2</label> <input id="fees" placeholder="Fees" type="checkbox"
									name="facilties" value="facilty 2"> <label
									for="facility">faclity 3</label> <input id="fees"
									placeholder="Fees" type="checkbox" name="facilties"
									value="facilty 3"> <label for="facility">faclity
									4</label> <input id="fees" placeholder="Fees" type="checkbox"
									name="facilties" value="facilty 4">
							</div>
						</div>
					</div>
					<div class="row">
